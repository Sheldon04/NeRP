...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image):
        ...
        return logits, logits_rep, logits_fusion, image_features, text_features, image_features_rep
...
class MMRL(TrainerX):
    ...
    def forward_backward(self, batch):
        ...
        if prec == "amp":
            with autocast():
                ...
                logits, logits_rep, logits_fusion, image_features, text_features, _ = model(image)
    ...
    def test(self, split=None):
        ...
        for batch_idx, batch in enumerate(tqdm(data_loader)):
            ...
            logits, _, logits_fusion, _, _, _ = self.model(input)
